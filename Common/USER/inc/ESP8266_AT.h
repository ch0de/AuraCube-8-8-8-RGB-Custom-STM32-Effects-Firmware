...
const char ESP8266_TCP_SENDBUF[] = "+CIPSENDBUF"; // Send Data
const char ESP8266_TCP_SENDEX[] = "+CIPSENDEX"; // Send Data //ESP32 doesn't support SENDBUF
const char ESP8266_TCP_CHECKBUF[] = "+CIPBUFSTATUS"; // Check Buffer free space
